{application,riak_kv,
             [{description,"Riak Key/Value Store"},
              ...
              {modules,[json_pp,raw_link_walker,riak,riak_client,riak_core_pb,
                        ...
                        riak_kv_cinfo,riak_kv_console,riak_kv_counter,
                        riak_kv_coverage_filter,riak_kv_crdt,
                        ...
                        riak_kv_mrc_map,riak_kv_mrc_pipe,riak_kv_mrc_sink,
                        ...
                        riak_kv_pb_crdt,riak_kv_pb_csbucket,riak_kv_pb_index,
                        riak_kv_pb_mapred,riak_kv_pb_object,riak_kv_pipe_get,
                        riak_kv_pipe_index,riak_kv_pipe_listkeys,
                        riak_kv_pncounter,riak_kv_put_core,riak_kv_put_fsm,
                        riak_kv_put_fsm_sup,riak_kv_reformat,riak_kv_stat,
                        riak_kv_stat_bc,riak_kv_stat_worker,riak_kv_status,
                        riak_kv_sup,riak_kv_test_util,riak_kv_util,
                        riak_kv_vnode,riak_kv_vnode_status_mgr,
                        riak_kv_w1c_sup,riak_kv_w1c_worker,riak_kv_w_reduce,
                        riak_kv_web,riak_kv_wm_bucket_type,riak_kv_wm_buckets,
                        ...
                        riak_kv_yessir_backend,riak_object,riak_object_json,
                        sms,tracer_accumulating_time,tracer_backend_latency,
                        tracer_eleveldb_put_size,tracer_fsm_init,
                        tracer_func_args,tracer_gc_latency,tracer_large4,
                        tracer_latency_histogram,tracer_merge_and_and_handoff,
